      ...
      <main className="max-w-7xl mx-auto grid md:grid-cols-3 gap-1 mt-8">
        ...
        <article className="md:col-span-2 bg-putih p-7 rounded-lg  box-shadow-card ">
          ...
          <p className="font-normal text-sm leading-tight truncate font-font-quick pt-2">
            Stock: <span className="font-semibold text-base">{props.product_qty}</span>
          </p>
          ...
          <section className="grid md:grid-cols-2 gap-8 mt-4">
            <div className="grid md:grid-cols-5">
              <BsTrash className="text-2xl cursor-pointer" key={props.id_cart} onClick={() => deleteCarts(props.id_cart)} />
            ...
            <div className="grid md:grid-cols-6">
              <FcMinus className="text-xl cursor-pointer" key={props.id_cart} onClick={() => minCarts(props.price)}/>
              <input
                id="input-qty"
                type="text"
                ...
                disabled
              />
              <FcPlus className="text-xl mx-5 cursor-pointer" key={props.id_cart} onClick={() => plusCarts(props.price)}/>
            </div>
          </section>
        </article>
      </main>
